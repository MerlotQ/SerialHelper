...
namespace Be.Windows.Forms
{
	...
	public class HexBox : Control
	{
        ...
        delegate void _vScrollBarEnableback(bool state,int max);
        private void set_vScrollBarEnable(bool state, int max)
        {
            // InvokeRequired required compares the thread ID of the
            // calling thread to the thread ID of the creating thread.
            // If these threads are different, it returns true.
            if (this._vScrollBar.InvokeRequired)
            {
                _vScrollBarEnableback d = new _vScrollBarEnableback(set_vScrollBarEnable);
                this.Invoke(d, new object[] { state, max });
            }
            else
            {
                if (max > 0)
        ...
        void UpdateVScroll()
		{
			...
			if(max > 0)
			{ 
                set_vScrollBarEnable(true,max);
			}
			else
			{
                set_vScrollBarEnable(false,max);
            }
		}
        ...
        {
            byte[] buffer = new byte[_byteProvider.Length];
            for (long i = 0; i < _byteProvider.Length; i++)
            {
                buffer[i] = _byteProvider.ReadByte(i);
            }
            return buffer;
        }
        ...
        /// </summary>
        /// <remarks>
        /// 当设置为true,HexBox只读,无法编辑。
        /// </remarks>
        [DefaultValue(false), Category("Hex"), Description("获取或设置HexBox是否只读。")]
        ...
        /// </summary>
        /// <remarks>
        /// UsedFixedBytesPerLine 属性必须设置为 true
        /// </remarks>
        [DefaultValue(16), Category("Hex"), Description("获取或设置一行中的字节数的最大值。")]
        ...
        /// </summary>
        /// <remarks>
        /// 当设置为true，BytesPerline属性确定在一个线的最大字节数。
        /// </remarks>
        [DefaultValue(false), Category("Hex"), Description("获取或设置一条行中的字节数是否固定。")]
        ...
        /// 获取或设置垂直滚动条的可见性。
        /// </summary>
        [DefaultValue(false), Category("Hex"), Description("获取或设置垂直滚动条的可见性。")]
        ...
        /// 获取或设置行信息的可见性。
        /// </summary>
        [DefaultValue(false), Category("Hex"), Description("获取或设置行信息的可见性。")]
        ...
        /// 获取或设置十六进制框边框样式。
        /// </summary>
        [DefaultValue(typeof(BorderStyle), "Fixed3D"), Category("Hex"), Description("获取或设置十六进制框边框样式。")]
        ...
        /// 获取或设置字符串视图的可见性。
        /// </summary>
        [DefaultValue(false), Category("Hex"), Description("获取或设置字符串视图的可见性。")]
        ...
        /// <summary>
        /// 获取或设置是否hexbox控制大写或小写字符显示。
        /// </summary>
        [DefaultValue(typeof(HexCasing), "Upper"), Category("Hex"), Description("获取或设置是否hexbox控制大写或小写字符显示。")]
        ...
        /// <summary>
        /// 获取或设置行信息颜色。当此属性为空，则使用ForeColor属性。
        /// </summary>
        [DefaultValue(typeof(Color), "Empty"), Category("Hex"), Description("获取或设置行信息颜色。当此属性为空，则使用ForeColor属性。")]
        ...
        /// 获取或设置所选字节的背景颜色。
        /// </summary>
        [DefaultValue(typeof(Color), "Blue"), Category("Hex"), Description("获取或设置所选字节的背景颜色。")]
        ...
        /// 获取或设置所选字节的前景颜色。
        /// </summary>
        [DefaultValue(typeof(Color), "White"), Category("Hex"), Description("获取或设置所选字节的前景颜色。")]
        ...
        /// 获取或设置阴影选择的可见性。
        /// </summary>
        [DefaultValue(true), Category("Hex"), Description("获取或设置阴影选择的可见性。")]
        ...
        /// Default alpha = 100
        /// </remarks>
        [Category("Hex"), Description("获取或设置阴影选择的颜色。")]
